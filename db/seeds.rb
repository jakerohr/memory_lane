...
partial2 = Partial.create(path: "two_for_three", name: "Two for Three", item1: "Input text here", item2: "And here...", item3: "Or even here!")
...
partial8 = Partial.create(path: "freatured", name: "Featured", item1: "http://res.cloudinary.com/memoryln/image/upload/v1431036123/test_images/lighthouse-93487_1280.jpg")
...
partial10 = Partial.create(path: "circle", name: "Circle", item1: "/test_images/lighthouse-93487_1280.jpg", item2: "Look at this craaazzzy text!", item3: "http://res.cloudinary.com/memoryln/image/upload/v1431036123/test_images/lighthouse-93487_1280.jpg")
